...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_Token_refreshToken'), 'Token', ['refreshToken'], unique=True)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('Token', sa.Column('accesToken', sa.VARCHAR(), autoincrement=False, nullable=True))
