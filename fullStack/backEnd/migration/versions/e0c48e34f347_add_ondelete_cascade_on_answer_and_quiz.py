...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'Answer', 'Question', ['questionId'], ['id'], ondelete='CASCADE')
    op.drop_constraint('Quiz_authorId_fkey', 'Quiz', type_='foreignkey')
    op.create_foreign_key(None, 'Quiz', 'User', ['authorId'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('Answer_questionId_fkey', 'Answer', 'Question', ['questionId'], ['id'])
    # ### end Alembic commands ###
